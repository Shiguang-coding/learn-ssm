> 在线视频：[尚硅谷新版SSM框架全套视频教程，Spring6+SpringBoot3最新SSM企业级开发](https://www.bilibili.com/video/BV1AP411s7D7?p=128)
>
> 在线文档：[框架实战：SSM整合原理和实战](https://www.wolai.com/m4CDNzUs7vj9Ki2hdxExbT)
>
...
![image-20240908204343760](images/66dd9bfe506b6.png)

情况2：子IoC容器可以单向的注入父IoC容器的组件！

![image-20240908204353580](images/66dd9c0775442.png)
...
![image-20240908204425632](images/66dd9c289d906.png)

### 第四问：具体多少配置类以及对应容器关系？

配置类的数量不是固定的，但是至少要两个，为了方便编写，我们可以三层架构每层对应一个配置类，分别指定两个容器加载即可！

![image-20240908204453054](images/66dd9c4406d97.png)
...
![image-20240908204508676](images/66dd9c5424026.png)
...
![image-20240908204533530](images/66dd9c6c3e18e.png)
...
### **整合方式1** （保留mybatis-config.xml）

#### 介绍

依然保留mybatis的外部配置文件（xml）, 但是数据库连接信息交给Druid连接池配置！

![image-20240908204546058](images/66dd9c7893e90.png)
...
![image-20240908204611442](images/66dd9c915c66b.png)
...
![image-20240908204628966](images/66dd9ca33a5f2.png)
...
1.  打开官网 [https://nodejs.org/en/](https://nodejs.org/en/ "https://nodejs.org/en/") 下载对应操作系统的 LTS 版本。（16.16.0）
    ...
    [node-v16.16.0-x64.msi](https://nodejs.org/download/release/v16.16.0/node-v16.16.0-x64.msi)
...
![image-20240908204641915](images/66dd9cb0acfcb.png)
...
![image-20240908204657374](images/66dd9cbf9edf4.png)

启动测试即可

### 跨域问题

> [【尚硅谷】跨域解决方案梳理](https://blog.shiguang666.eu.org/2024/07/25/2c116e8f42c9/)

由于前后端服务端口不一致，会导致跨域问题

后端控制层需要添加`@CrossOrigin` 注解允许其他源访问我们的controller
